...
export const GUIDES: Guide[] = [
  { slug: 'best-gaming-laptops', title: 'Best Gaming Laptops (2026): Ranked by Real GPU Benchmarks', h1: 'Best Gaming Laptops for 2026: Benchmark-Ranked & Tested', scoreKey: 'gaming',
    ...
    intro: 'Choosing the best gaming laptop in 2026 comes down to matching thermal headroom, real GPU wattage, and display refresh rates to your target resolution. We ran standardized PassMark CPU and G3DMark GPU benchmarks across 40+ dedicated gaming rigs—from sub-$800 RTX 40-series machines to 175W RTX 5090 flagships—to rank the top performers without manufacturer bias. Below is our benchmark-verified ranking, broken down by budget and playstyle.',
  ...
  { slug: 'best-gaming-laptops-under-1500', title: 'Best Gaming Laptops Under $1500 in 2026', h1: 'Best Gaming Laptops Under $1500', scoreKey: 'gaming',
    ...
    intro: 'Under $1,500 is the most competitive gaming laptop tier. We filter out compromise machines and rank the fastest dedicated GPU laptops using the same standardized criteria as our main <a href="/guides/best-gaming-laptops" class="text-brand-600 dark:text-brand-400 font-semibold hover:underline">best gaming laptops guide</a>.',
  ...
  { slug: 'best-thin-and-light-gaming-laptops', title: 'Best Thin & Light Gaming Laptops in 2026', h1: 'Best Thin & Light Gaming Laptops', scoreKey: 'gaming',
    ...
    intro: 'Portable gaming rigs no longer require sacrificing performance. These are the lightest dedicated GPU laptops in our <a href="/guides/best-gaming-laptops" class="text-brand-600 dark:text-brand-400 font-semibold hover:underline">top gaming laptop picks</a>, tested for thermal balance, fan noise, and on-the-go battery longevity.',
  ...
  { slug: 'best-1440p-gaming-laptops', title: 'Best 1440p & 1600p QHD Gaming Laptops in 2026', h1: 'Best 1440p & 1600p QHD Gaming Laptops', scoreKey: 'gaming',
    ...
    intro: '1440p (QHD) and 16:10 1600p QHD displays are now the visual sweet spot for competitive PC gaming. Linked to our master guide on the <a href="/guides/best-gaming-laptops" class="text-brand-600 dark:text-brand-400 font-semibold hover:underline">best gaming laptops</a>, these selections feature high-refresh, color-accurate displays backed by powerful discrete GPUs.',
  ...
  { slug: 'best-rtx-5060-laptops', title: 'Best RTX 5060 Laptops in 2026', h1: 'Best RTX 5060 Laptops', scoreKey: 'gaming',
    ...
    intro: 'The RTX 5060 is 2026’s sweet-spot GPU for high-refresh 1080p and 1440p esports. For higher GPU tiers and desktop-class flagships, see our master guide to the <a href="/guides/best-gaming-laptops" class="text-brand-600 dark:text-brand-400 font-semibold hover:underline">best gaming laptops</a>.',
